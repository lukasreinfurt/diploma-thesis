...
public class UiextensionmodelPackageImpl extends EPackageImpl implements UiextensionmodelPackage {
	 ...
	 * @generated
	 */
	private EEnum bpelStatesEEnum = null;
	 ...
	 * 
	 * <p>This method is used to initialize {@link UiextensionmodelPackage#eINSTANCE} when that field is accessed.
	...
	public static UiextensionmodelPackage init() {
		...
		UiextensionmodelPackageImpl theUiextensionmodelPackage = (UiextensionmodelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof UiextensionmodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new UiextensionmodelPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(UiextensionmodelPackage.eNS_URI, theUiextensionmodelPackage);
	 ...
	 * @generated
	 */
	public EAttribute getProcessExtension_ProcessName() {
		return (EAttribute)processExtensionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getProcessExtension_ProcessVersion() {
		return (EAttribute)processExtensionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getInstanceState_State() {
	 ...
	 * @generated
	 */
	public EAttribute getVariableExtension_Parameter() {
		return (EAttribute)variableExtensionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getVariableExtension_Default() {
		return (EAttribute)variableExtensionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EEnum getBPELStates() {
		return bpelStatesEEnum;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(processExtensionEClass, PROCESS_EXTENSION__PROCESS_NAME);
		createEAttribute(processExtensionEClass, PROCESS_EXTENSION__PROCESS_VERSION);
		...
		createEAttribute(instanceStateEClass, INSTANCE_STATE__STATE);
		...
		createEAttribute(variableExtensionEClass, VARIABLE_EXTENSION__PARAMETER);
		createEAttribute(variableExtensionEClass, VARIABLE_EXTENSION__DEFAULT);

		// Create enums
		bpelStatesEEnum = createEEnum(BPEL_STATES);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getProcessExtension_ProcessName(), ecorePackage.getEString(), "processName", null, 0, 1, ProcessExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcessExtension_ProcessVersion(), ecorePackage.getELong(), "processVersion", null, 0, 1, ProcessExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(instanceStateEClass, InstanceState.class, "InstanceState", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInstanceState_State(), this.getBPELStates(), "state", null, 0, 1, InstanceState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getVariableExtension_Parameter(), ecorePackage.getEBoolean(), "parameter", null, 0, 1, VariableExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVariableExtension_Default(), ecorePackage.getEString(), "default", null, 0, 1, VariableExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(bpelStatesEEnum, BPELStates.class, "BPELStates");
		addEEnumLiteral(bpelStatesEEnum, BPELStates.INITIAL);
		addEEnumLiteral(bpelStatesEEnum, BPELStates.EXECUTING);
		addEEnumLiteral(bpelStatesEEnum, BPELStates.SUSPENDED);
		addEEnumLiteral(bpelStatesEEnum, BPELStates.FAULTED);
		addEEnumLiteral(bpelStatesEEnum, BPELStates.TERMINATED);
		addEEnumLiteral(bpelStatesEEnum, BPELStates.COMPLETED);
		addEEnumLiteral(bpelStatesEEnum, BPELStates.BLOCKING);
