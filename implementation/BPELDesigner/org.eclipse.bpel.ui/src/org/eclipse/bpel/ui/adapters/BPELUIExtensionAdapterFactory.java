...
public class BPELUIExtensionAdapterFactory extends UiextensionmodelAdapterFactory {
	...
	/**
	 * @see org.eclipse.bpel.ui.uiextensionmodel.util.UiextensionmodelAdapterFactory#createInstanceStateAdapter()
	 */
	@Override
	public Adapter createInstanceStateAdapter() {
		return provider.getAdapter( InstanceStateNodeAdapter.class);
	}
