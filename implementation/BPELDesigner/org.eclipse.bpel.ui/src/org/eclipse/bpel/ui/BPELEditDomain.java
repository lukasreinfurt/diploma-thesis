...
public class BPELEditDomain extends DefaultEditDomain {
	...
	// @hahnml: We need this to get the instance state in a figure.
	InstanceState instanceNode;
	...
	public BPELEditDomain(IEditorPart editorPart) {
		...
		// @hahnml: Create a new InstanceState object.
		instanceNode = UiextensionmodelFactory.eINSTANCE.createInstanceState();
	}
	...
	public void setProcess(Process process) {
		...
		instanceNode.setProcess(process);
	}

	// @hahnml: Getter and Setter for the InstanceState object of the model.
	public InstanceState getInstanceNode() {
		return instanceNode;
	}

	public void setInstanceState(BPELStates state) {
		instanceNode.setState(state);
	}
}
