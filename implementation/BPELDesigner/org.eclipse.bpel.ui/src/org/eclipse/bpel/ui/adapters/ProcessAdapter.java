	...
	IExtensionFactory, IEditPartActionContributor
{
	...
	public IContainer createContainerDelegate() {
		...
		omc.add(new IndirectContainer(BPELPackage.eINSTANCE.getProcess_ReferenceVariables(),			
				new ReferenceContainer(BPELPackage.eINSTANCE.getReferenceVariables_Children())));
		omc.add(new IndirectContainer(BPELPackage.eINSTANCE.getProcess_ContainerReferenceVariables(),			
				new ReferenceContainer(BPELPackage.eINSTANCE.getContainerReferenceVariables_Children())));
		omc.add(new IndirectContainer(BPELPackage.eINSTANCE.getProcess_DataSourceReferenceVariables(),			
				new ReferenceContainer(BPELPackage.eINSTANCE.getDataSourceReferenceVariables_Children())));
