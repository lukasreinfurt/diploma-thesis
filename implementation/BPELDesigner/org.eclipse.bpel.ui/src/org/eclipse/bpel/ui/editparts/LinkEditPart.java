...
public class LinkEditPart extends AbstractConnectionEditPart {
	...
	//@hahnml: Make the connection figure accessible
	private BPELPolylineConnection connection;
...
//			}
	...
	protected IFigure createFigure() {
		...
		connection = new BPELPolylineConnection(topLeft, topRight, bottomLeft, bottomRight, arrowDown, arrowRight);
		applyConnectionRouter(connection);
		return connection;
	}
	...
	protected void refreshVisuals() {
		...
		//@hahnml: Color the link
		this.connection.setLinkStateColor(AgoraHelper.colorLink(getModel()));
