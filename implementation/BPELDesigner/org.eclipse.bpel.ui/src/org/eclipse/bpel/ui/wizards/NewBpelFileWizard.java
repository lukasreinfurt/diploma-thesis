...
import org.eclipse.bpel.ui.wizards.simtech.NewFileWizardPageMetaData;
...
public class NewBpelFileWizard extends Wizard implements INewWizard {
	...
	/**
	 * The last page of the wizard. Used for the specification of 
	 * meta-data properties for the new BPEL process model. These
	 * properties uniquely address the process model. 
	 * 
	 * @author sonntamo
	 */
	private NewFileWizardPageMetaData fMetaDataPage;
	...
	public void addPages() {
		...
		// @sonntamo
		// create a new page for the specification of process model meta-data  
		this.fMetaDataPage = new NewFileWizardPageMetaData(Messages.NewFileWizard_1,
				Messages.NewFileWizardPage1_2);
		...
		// @sonntamo
		// The meta-data properties page is the last.
		addPage( this.fMetaDataPage );
	}
	...
	public boolean canFinish() {
		...
		// @sonntamo
		// At least one meta-data property must be specified for a new 
		// BPEL process model.
		boolean complete = this.firstPage.isPageComplete() && this.locationPage.isPageComplete() && fMetaDataPage.isPageComplete();
		if( complete ) {
			...
			throws InvocationTargetException, InterruptedException {
				...
				try {
					...
					NewBpelFileWizardUtils utils = new NewBpelFileWizardUtils(
							...
							NewBpelFileWizard.this.fMetaDataPage,
