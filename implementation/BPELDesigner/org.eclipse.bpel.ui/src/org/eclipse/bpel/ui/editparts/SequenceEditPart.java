...
public class SequenceEditPart extends CollapsableEditPart {
	...
	/**
	 * Sets a new icon to this sequence activity. 
	 * 
	 * @param img The new icon
	 * 
	 * @author sonntamo
	 */
	public void setNewIcon(Image img) {
		...
		CollapsableBorder colBorder = (CollapsableBorder)getContentFigure().getBorder();
		colBorder.setNewImage(image);
	}
