 ...
 * @author sonntamo
 */
public class XSDLabelProvider extends LabelProvider implements
		ITableLabelProvider {
	...
	// Set column names
	private static String[] columnNames = new String[] { COLUMN_CHECK,
			COLUMN_FILENAME, COLUMN_TNS };
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		case 3:
			...
			result = FragmentUtils.getUtils(null).checkIfProjectContainsFile(xsd) ? "true" : "false";
			break;
		default:
			break;
		}
	...
	public Image getColumnImage(Object element, int columnIndex) {
		...
		getImage(((XSDImpl) element).isSelected())
				: null;
	}
	...
	public static Table createTable(Composite parent) {
		...
		//@hahnml
		// 4th column with task existsAlready
