...
public class FaultHandlerEditPart extends BPELEditPart implements ILayoutAware{
	...
	protected IFigure createFigure() {
		...
		//@hahnml: Fix for the color problem with fault handlers
		container.setBackgroundColor(BPELUIPlugin.INSTANCE.getColorRegistry().get(IBPELUIConstants.COLOR_WHITE));
