...
public class NewBpelFileWizardUtils {
	...
	//@hahnml: Added the NewFileWizardPageMetaData
	private final NewFileWizardPageMetaData metaDataPage;
	...
	public NewBpelFileWizardUtils(
			...
			NewFileWizardPageMetaData fMetaDataPage, NewBpelFileTemplatePage wsdlPage,
			NewBpelFilePortTypePage portTypePage,
			IFile targetFile ) {

		this.firstPage = firstPage;
		//@hahnml: Initialize the page
		this.metaDataPage = fMetaDataPage;
	...
	public void createResourcesFromTemplate( IProgressMonitor monitor ) throws CoreException {
		...
		// @sonntamo
		// store the meta-data properties in the deployment descriptor
		FileOperations.storePropertiesToDD(this.targetFile.getParent(), this.metaDataPage.getEntries());
	}
