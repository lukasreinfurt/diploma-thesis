 ...
 *   <li>{@link org.eclipse.bpel.ui.uiextensionmodel.impl.VariableExtensionImpl#isParameter <em>Parameter</em>}</li>
 *   <li>{@link org.eclipse.bpel.ui.uiextensionmodel.impl.VariableExtensionImpl#getDefault <em>Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableExtensionImpl extends EObjectImpl implements VariableExtension {
	...
	public void setParameter(boolean newParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiextensionmodelPackage.VARIABLE_EXTENSION__PARAMETER, oldParameter, parameter));
	}
	...
	public void setDefault(String newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiextensionmodelPackage.VARIABLE_EXTENSION__DEFAULT, oldDefault, default_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UiextensionmodelPackage.VARIABLE_EXTENSION__ADVANCED_KIND:
				return getAdvancedKind();
			case UiextensionmodelPackage.VARIABLE_EXTENSION__VARIABLE_KIND:
				return getVariableKind();
			case UiextensionmodelPackage.VARIABLE_EXTENSION__PARAMETER:
				return isParameter();
			case UiextensionmodelPackage.VARIABLE_EXTENSION__DEFAULT:
				return getDefault();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case UiextensionmodelPackage.VARIABLE_EXTENSION__ADVANCED_KIND:
				setAdvancedKind((Integer)newValue);
				return;
			case UiextensionmodelPackage.VARIABLE_EXTENSION__VARIABLE_KIND:
				setVariableKind((Integer)newValue);
				return;
			case UiextensionmodelPackage.VARIABLE_EXTENSION__PARAMETER:
