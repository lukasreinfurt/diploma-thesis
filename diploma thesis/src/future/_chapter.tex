...
The plugin selection will certainly have to be extended in the future to cover a wider range of cloud providers (or other infrastructure types), communication mechanisms, and applications.
...
For example, if for some reason a connection can not be established with a cloud provider, the bootware will abort and undeploy already provisioned applications.
