...
So for us, provisioning means the creation and deletion of virtual VMs in a cloud environment, as well as the installation, configuration, monitoring, running and stopping of software on these VMs\autocite{towardsprovisioning}
