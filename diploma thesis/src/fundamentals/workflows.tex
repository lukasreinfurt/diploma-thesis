...
For the example in \autoref{image:workflow}, this could mean that the Workflow Management System presents an employee with a graphical user interface, where he can select the payment method based on the choice of a customer.
