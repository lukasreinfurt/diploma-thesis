...
For the example in \autoref{image:workflow} this could mean, that the Workflow Management System presents an employee with a \nom{graphical user interface}{GUI}, where he can select the payment method based on the choice of a customer.
...
This lead to the development of business-centered standards like the \nom{Business Process Execution Language}{BPEL}\footnote{\url{http://docs.oasis-open.org/wsbpel/2.0/OS/wsbpel-v2.0-OS.html}} or the \nom{Business Process Modeling Notation}{BPMN}\footnote{\url{http://www.bpmn.org/}} to describe workflows, and corresponding Workflow Management System that can execute these workflows.
