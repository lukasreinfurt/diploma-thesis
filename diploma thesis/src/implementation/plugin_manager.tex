...
For example, once the state machine enters the unload event plugins state, associated with the activities shown in the top right of \autoref{image:flow_local} and \autoref{image:flow_remote}, it executes the unloadEventPlugins method, shown in \autoref{lst:unloadeventplugins}.
