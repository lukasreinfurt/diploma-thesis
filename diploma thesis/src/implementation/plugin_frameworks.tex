...
Java provides an integrated extension mechanism called \nom{Service Provider Interface}{SPI}, which is a little more advanced then the manual extension mechanism described above.
...
However, unlike in the above approach, specific implementations are loaded from .jar files in specific directories or in the class path.
