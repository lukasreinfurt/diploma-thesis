...
\begin{listing}[!htbp]
	...
	\caption{Extension points defined in org.eclipse.bpel.ui.}
	\label{lst:pluginxml}
\end{listing}
...
As we can see in line 1188, the class that implements the button functionality is \textit{org.eclipse.bpel.ui.agora.actions.StartAction}.
...
Once it is running, a deploy request is send to it, containing a context object with all necessary configuration parameters.
