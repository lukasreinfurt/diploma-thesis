...
If an event is published, all event handlers for this event should be executed one after another until they finished execution.
...
But its age is also is weakness.

Guava Event Bus is a fairly simple PubSub library.
...
It lacks some of the advanced features of EventBus but is also simpler to use.
