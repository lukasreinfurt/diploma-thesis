...
In this plugin, the init operation does not take any actions.
...
Unlike the other plugins, it does not implement any other interface operations apart from the standard init and shutdown operations.
...
The init operation creates a writer object which opens a text file to write into.
...
The shutdown operation just closes the write object that was created by the init operation.
