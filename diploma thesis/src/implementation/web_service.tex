...
It contains a list of endpoint references in line 5-10, which contains a reference to the application that was deployed during the request, in this case OpenTOSCA.
...
\begin{listing}[!htbp]
	...
	\caption{Sample getActiveApplications request in a soap message.}
...
\begin{listing}[!htbp]
	...
	\caption{Sample getActiveApplications response in a soap message.}
...
\begin{listing}[!htbp]
	...
	\caption{Sample getActiveApplications error in a soap message.}
