...
In the example code in line 9, we send one credentials set for AWS, which consists of two credentials, a secret key in line 12-15 and a accessKey in line 16-19.
