...
If the setCredential operation was successful, the response in \autoref{lst:webservice:setcredentialsresponse} will be returned.
...
As can be seen in \autoref{lst:webservice:setcredentialserror}, it also contains a soap fault string in line 5 and the original SetCredentialsException thrown by the setCredential operation in line 7-10.
