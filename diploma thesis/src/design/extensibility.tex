...
There are several possibilities to realize a plugin an architecture.
...
The plugin manager might also support various other utility operations for convenience, such as an unloadAllPlugins, which would unload all loaded plugins at once.
