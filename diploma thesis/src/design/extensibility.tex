...
\textcolor{red}{SPI, CDI, other mechanisms?}
\url{https://vaadin.com/blog/-/blogs/developing-modular-vaadin-applications-without-osgi}
...
To remove this disadvantage, a more flexible architecture is needed, for example a plugin architecture.
