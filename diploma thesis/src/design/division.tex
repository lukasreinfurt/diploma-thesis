...
First, we consider the simplest case: A single local component as shown in \autoref{image:local}.
...
Either, the user provisions the bootware once in some cloud environment and then keeps this one instance running, or they provision it once they need it and deprovisions it when they are done.
