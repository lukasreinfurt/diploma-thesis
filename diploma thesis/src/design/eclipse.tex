...
First, the adapter has to start the local bootware component so that it will be in a state where it can receive and process requests.
...
Once the local bootware component is running, the adapter has to set up the context for the following requests.
