...
Because these plugins offer identical functionality, it makes sense to use the same plugins for both the bootware and the provisioning manager.
...
For these plugins, we will use the implementation provided by~\autocite{nedim}.
