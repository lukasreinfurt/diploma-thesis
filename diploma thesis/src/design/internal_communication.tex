...
\begin{description}
	...
	\begin{description}
		...
		\begin{description}
			\item[PluginManagerEvent] -
			\begin{description}
				\item[PluginLoadEvent] -
				\item[PluginUnloadEvent] -
				\item[\ldots] -
			\end{description}
			\item[\ldots] -
		\end{description}
	...
	\begin{description}
		...
		\begin{description}
			\item[InfrastructurePluginEvent] -
			\item[ConnectionPluginEvent] -
			\item[PayloadPluginEvent] -
			\item[ProvisioningEnginePluginEvent] -
			\item[EventPluginEvent] -
		\end{description}
	\end{description}
\end{description}
